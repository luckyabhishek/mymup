...
import Dashboard3 from '../views/Dashboards/Dashboard3.vue'
import Dashboard4 from '../views/Dashboards/Dashboard4.vue'
import Dashboard5 from '../views/Dashboards/Dashboard5.vue'
import Dashboard6 from '../views/Dashboards/Dashboard6.vue'
import Dashboard7 from '../views/Dashboards/Dashboard7.vue'
/* UIElements View */
...
const childRoutes = (prop, mode) => [
  ...
  },
  {
    path: 'home-6',
    name: prop + '.home-6',
    meta: { dark: mode, auth: true, name: 'Home 6' },
    component: Dashboard6
  },
  {
    path: 'home-7',
    name: prop + '.home-7',
    meta: { dark: mode, auth: true, name: 'Home 7' },
