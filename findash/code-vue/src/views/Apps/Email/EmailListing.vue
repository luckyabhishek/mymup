            ...
            <div class="iq-email-list">
              ...
              <tab-nav :pills="true" vertical id="myTab" class="iq-email-ui" @change="updateTab">
                <tab-nav-items
                  ...
                  :active="true"
                  id="mail-inbox-tab"
                  aria-controls="mail-inbox"
                  role="tab"
                  :ariaSelected="true"
                >
                  <template v-slot:title>
                    <i class="ri-mail-line" />Inbox
              ...
              <ul class="iq-email-ui iq-email-label">
                <li>
                  <a href="#">
                    <i class="ri-focus-fill text-primary"></i>Personal
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="ri-focus-fill text-danger"></i>Company
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="ri-focus-fill text-success"></i>Important
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="ri-focus-fill text-info"></i>Private
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="ri-focus-fill text-warning"></i>Private
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="ri-add-circle-line"></i>Add New Labels
                  </a>
                </li>
              </ul>
          ...
          <div class="iq-email-listbox">
            <tab-content>
              ...
              >
                <ul class="iq-email-sender-list">
                  <li
                    v-for="(items,index) in deleteItems"
                    :key="index"
                    :class="items.is_unread ? 'iq-unread' : ''"
                  >
                    <EmailItem :items="items" @update="openDetail" />
