            ...
            <div class="d-flex justify-content-between">
              <ul>
                ...
                <li v-b-tooltip.top title="Forward">
                  <a href="#">
                    <i class="ri-folder-transfer-line" />
                  </a>
                </li>
          ...
          <div class="iq-inbox-subject p-3">
            ...
            <div class="iq-inbox-subject-info">
              <div class="iq-subject-info">
                <img
                  :src="require('../../../assets/images/user/user-1.jpg')"
                ...
                <div class="iq-subject-status align-self-center">
                  <h6 class="mb-0">
                    findash team
                    <a href="dummy@findash.com">dummy@findash.com</a>
                  </h6>
                  <div class="dropdown">
                    <a
              ...
              <div class="iq-inbox-body mt-5">
                ...
                <p class="mt-5 mb-0">
                  Regards,
                  <span class="d-inline-block w-100">John Deo</span>
                </p>
              </div>
              <hr />
              <div class="attegement">
                ...
                <ul>
                  <li class="icon icon-attegment">
                    ...
                    <span class="ml-1">mydoc.doc</span>
                  </li>
                  <li class="icon icon-attegment">
                    <i class="fa fa-file-text-o" aria-hidden="true"></i>
                    <span class="ml-1">mydoc.pdf</span>
                  </li>
                </ul>
              </div>
            </div>
