...
&lt;b-alert :show="true" variant="dark"&gt;
  &lt;div class="iq-alert-text"&gt;A simple &lt;b&gt;dark&lt;/b&gt; alert—check it out!&lt;/div&gt;
&lt;/b-alert&gt;
</code></pre>
                </kbd>
              </div>
            ...
            <b-alert :show="true" variant="primary">
              <div class="iq-alert-text">
                A simple
                <b>primary</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="secondary">
              <div class="iq-alert-text">
                A simple
                <b>secondary</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="success">
              <div class="iq-alert-text">
                A simple
                <b>success</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="danger">
              <div class="iq-alert-text">
                A simple
                <b>danger</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="warning">
              <div class="iq-alert-text">
                A simple
                <b>warning</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="info">
              <div class="iq-alert-text">
                A simple
                <b>info</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="light">
              <div class="iq-alert-text">
                A simple
                <b>light</b> alert—check it out!
              </div>
            </b-alert>
            <b-alert :show="true" variant="dark">
              <div class="iq-alert-text">
                A simple
                <b>dark</b> alert—check it out!
              </div>
            </b-alert>
          </template>
        </iq-card>
