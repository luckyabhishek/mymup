              ...
              <template v-slot:body>
                <div class="new-user-info">
                  <b-row>
                    ...
                    <b-form-group class="col-md-12" label="Company Name:" label-for="cname">
                      <b-form-input
                    ...
                    <b-form-group class="col-md-6" label="Alternate Contact:" label-for="altcon">
                      <ValidationProvider
                  ...
                  <div class="checkbox">
                    <label>
                      <input class="mr-2" type="checkbox" />Enable Two-Factor-Authentication.
                    </label>
                  </div>
...
export default {
  ...
  methods: {
    onSubmit () {
      ...
      findash.showSnackbar('success', 'User has been updated successfully.')
