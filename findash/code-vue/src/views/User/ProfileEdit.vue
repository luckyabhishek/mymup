                ...
                <tab-content-item :active="false" id="chang-pwd">
                  <iq-card>
                    ...
                    <template v-slot:body>
                      ...
                      <b-form-group label="New Password:" label-for="pass">
                        <ValidationProvider
                          name="Password"
                      ...
                      <b-form-group label="Repeat Password:" label-for="rpass">
                        <ValidationProvider
                          vid="repeat_password"
  ...
  data () {
    return {
      ...
      age: [
        ...
        { value: '19-32', text: '19-32' },
        { value: '33-45', text: '33-45' },
        { value: '46-62', text: '46-62' },
        { value: '63 > ', text: '63 > ' }
      ],
      countries: [
  ...
  methods: {
    onSubmit () {
      ...
      this.$firestoreRefs.user.update(this.user).then(() => {
        findash.showSnackbar('success', 'User has been added successfully.')
      })
