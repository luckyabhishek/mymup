      ...
      <b-col lg="6" sm="12">
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              The
              <code>.table</code> class adds basic styling to a table.
            </p>
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              ...
              <code class="highlighter-rouge">&lt;thead&gt;</code>s appear light or dark gray.
            </p>
...
&lt;/script&gt;
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Add
              <code class="highlighter-rouge">.table-borderless</code> for a table without borders.
            </p>
...
&lt;/script&gt;
            ...
            <b-table :items="items" borderless></b-table>
            <p>
              <code class="highlighter-rouge">.table-borderless</code> can also be used on dark tables.
            </p>
            <b-table :items="items" table-variant="dark" borderless></b-table>
          </template>
        </iq-card>
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              Add
              <code class="highlighter-rouge">.table-sm</code> to make tables more compact by cutting cell padding in half.
            </p>
...
&lt;/script&gt;
        ...
        <iq-card>
          ...
          <template v-slot:body>
            <p>
              A
              <code class="highlighter-rouge">&lt;caption&gt;</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.
            </p>
...
&lt;/b-table-simple&gt;
            ...
            <p>
              ...
              <a
                ...
                target="_blank"
              >text or background utilities</a> to achieve similar styles.
            </p>
            <b-table-simple table-variant="dark">
              <b-thead>
                <b-th>#</b-th>
          ...
          <template v-slot:body>
            <p>
              ...
              <code
                class="highlighter-rouge"
              >.table</code> with
              <code class="highlighter-rouge">.table-responsive</code>. Or, pick a maximum breakpoint with which to have a responsive table up to by using
              <code
                class="highlighter-rouge"
